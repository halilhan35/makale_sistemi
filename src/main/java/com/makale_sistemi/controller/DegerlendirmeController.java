...
public class DegerlendirmeController {
    ...
    public ResponseEntity<ServiceResponse> findAllWithPageable(Pageable pageable) {
        try {
            Page<DegerlendirmeDto> dtoPage = alanService.findAllWithPageable(pageable);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> findById(@PathVariable Long id) {
        try {
            DegerlendirmeDto dto = alanService.findById(id, true);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> saveOrUpdate(@RequestBody DegerlendirmeDto dto) {
        try {
            DegerlendirmeDto responseDto = alanService.saveOrUpdate(dto);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)

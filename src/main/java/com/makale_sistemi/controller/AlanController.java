...
public class AlanController {
    ...
    public ResponseEntity<ServiceResponse> findAllWithPageable(Pageable pageable) {
        try {
            Page<AlanDto> dtoPage = alanService.findAllWithPageable(pageable);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> findById(@PathVariable Long id) {
        try {
            AlanDto dto = alanService.findById(id, true);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> saveOrUpdate(@RequestBody AlanDto dto) {
        try {
            AlanDto responseDto = alanService.saveOrUpdate(dto);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)

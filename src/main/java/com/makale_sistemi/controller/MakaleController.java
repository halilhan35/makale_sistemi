...
public class MakaleController {
    ...
    public ResponseEntity<ServiceResponse> findAllWithPageable(Pageable pageable) {
        try {
            Page<MakaleDto> dtoPage = makaleService.findAllWithPageable(pageable);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> findById(@PathVariable Long id) {
        try {
            MakaleDto dto = makaleService.findById(id, true);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
    ...
    public ResponseEntity<ServiceResponse> saveOrUpdate(@RequestBody MakaleDto dto) {
        try {
            MakaleDto responseDto = makaleService.saveOrUpdate(dto);
            return ResponseEntity.ok(ServiceResponse
                    .builder()
                    .success(true)
                    .statusCode(200)
